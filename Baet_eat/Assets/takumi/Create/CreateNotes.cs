...
public class CreateNotes : MonoBehaviour
{
    ...
    private void Load(string SongName)
    {
        ...
        for (int i = 0; i < inputJson.notes.Length; i++)
        {
            ...
            notes.transform.position = new Vector3((inputJson.notes[i].block) - 3.5f - (float)inputJson.notes[i].renge / 2.0f, 0.03f,( kankaku * inputJson.notes[i].num * InGameStatus.GetSpeed() * 20)+offset);
            //親に纏める
