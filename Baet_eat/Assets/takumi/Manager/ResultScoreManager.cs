...
public class ResultScoreManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        DifficultyNameJukcet.text = publicEnum.Difficulty.Hors_d_oeuvre.GetName();//ScoreStatus.nowDifficulty.ToString();
    ...
    {
        publicEnum.ClearRank rank = publicEnum.ClearRank.A; ;//InGameStatus.GetScoreClearRank((int)InGameStatus.GetScore());
        int RankIndex = 0;
